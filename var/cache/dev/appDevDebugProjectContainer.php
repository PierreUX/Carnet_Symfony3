...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\AdresseBundle\\Entity'))), 'AdresseBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('AdresseBundle' => 'AdresseBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_96703e3448542d01a634ec94953fcaa36a89a029a16d433ed081a4de588665f4');
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $e = new \Symfony\Component\HttpFoundation\RequestMatcher('^/ajout');

        $f = new \Symfony\Component\HttpFoundation\RequestMatcher('^/index');

        $g = new \Symfony\Component\HttpFoundation\RequestMatcher('^/gestion');

        $h = new \Symfony\Component\HttpFoundation\RequestMatcher('^/suppr_');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\AdresseBundle/Resources/views'), 'Adresse');
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('56cc455e516099.99393838')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'AdresseBundle' => 'AdresseBundle\\AdresseBundle',
